...
export class DefaultPage extends Component {
  state = {hoveredArticleTitle: null};
  ...
  setHoveredArticle = (title) => {
    this.setState({hoveredArticleTitle: title});
  }
  ...
  render() {
    ...
    return (
      <div className="home-default-page">
        <Angus data={mockup_data} hoveredArticleTitle={this.state.hoveredArticleTitle} />
        <Bubbles data={mockup_data} setHoveredArticle={this.setHoveredArticle} />
      </div>
    );
  }
}
